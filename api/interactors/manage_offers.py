class ManageOffersInteractor(object):
    ...
    def set_params_base_offer(self, by_id=None, id=None, name=None, avaidable=None, price=None, addeds=None):
        self._by_id_base_offer = by_id
        self._id_base_offer = id
        self._name_base_offer = name
        self._avaidable_base_offer = avaidable
        self._price_base_offer = price
        self._addeds_base_offer = addeds

    def set_params_added(self, by_id=None, id=None, name=None, avaidable=None, price=None):
        self._by_id_added = by_id
        self._id_added = id
        self._name_added = name
        self._avaidable_added = avaidable
    ...
    def create_base_offer(self):
        return self._base_offer_repo.create(self._name_base_offer,
                                     self._avaidable_base_offer, self._price_base_offer,
                                     self._addeds_base_offer)

    def create_added(self):
        return self._added_repo.create(self._name_added, self._avaidable_added, self._price_added)
    ...
    def update_base_offer(self):
        return self._base_offer_repo.update(self._by_id_base_offer, self._id_base_offer, self._name_base_offer,
                                     self._avaidable_base_offer, self._price_base_offer, self._addeds_base_offer)
                                     
    def update_added(self):
        return self._added_repo.update(self._by_id_added, self._id_added, self._name_added, self._avaidable_added, self._price_added)
